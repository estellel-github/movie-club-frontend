...
export default function Header() {
  return (
    <div className="navbar bg-neutral-950 text-neutral-200 px-6 border-b-2 border-b-stone-800 ">
      {/* Left (Logo & Brand) */}
      ...
      <div className="navbar-end lg:hidden w-64">
        <div className="dropdown w-64">
          ...
          <ul
            tabIndex={0}
            className="menu menu-sm dropdown-content w-full bg-neutral-950 text-neutral-200 rounded-box z-[1] mt-3 p-2 shadow"
          >
            <li>
